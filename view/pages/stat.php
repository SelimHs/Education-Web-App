...
function generateStatsByNbrE() {
    try {
        ...
        $query = $conn->prepare("SELECT nbrE, COUNT(*) as total_sessions FROM formation GROUP BY nbrE");
        $query->execute();
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Total des sessions par nombre d\'étudiants',
                    data: <?php echo $data; ?>,
